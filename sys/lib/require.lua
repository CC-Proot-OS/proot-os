...
local function make_package(env, dir)
    ...
    package.path = "?;?.lua;?/init.lua;/lib/?;/lib/?.lua;/lib/?/init.lua;/sys/lib/?;/sys/lib/?.lua;/sys/lib/?/init.lua;/rom/modules/main/?;/rom/modules/main/?.lua;/rom/modules/main/?/init.lua;/usr/lib/?;/usr/lib/?.lua;/usr/lib/?/init.lua"
    package.config = "/\n;\n?\n!\n-"
    package.preload = {}
